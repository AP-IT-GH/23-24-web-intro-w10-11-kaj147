    ...
    for (let i = 0; i < json.length - 2; i++) {
      ...
      html += `<div class="accordion-item">
            ...
            <h2 class="accordion-header">
              ...
              <img src="${recipe.image}" class="float-start img-small" alt="        "><span class="h6 mt-2">ingrediënten</span>: ${recipe.ingredients}<hr><span class="h6  mt-2">bereiding</span>: ${recipe.description}</div>
            </div>
      </div>`;
    }
    html += '</div>';
